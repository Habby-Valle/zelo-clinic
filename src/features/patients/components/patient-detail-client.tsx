    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Selecione os cuidadores que atendem este paciente.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          ...
          <div className="flex items-center gap-3">
            <Button
              onClick={handleSaveCaregivers}
              disabled={assignCaregivers.isPending}
            >
            ...
            {caregiverMsg && (
              <Alert
                variant={
                  caregiverMsg.includes("sucesso") ? "default" : "destructive"
                }
        ...
        <CardContent className="space-y-6">
          <form onSubmit={handleInviteFamily} className="flex items-end gap-3">
            ...
            <Button
              type="submit"
              disabled={
                inviteFamily.isPending || !inviteEmail.trim() || !clinicId
              }
            >
          ...
          {emergencyContacts.length === 0 && pendingInvites.length === 0 && (
            <p className="text-sm text-muted-foreground">
              Nenhum familiar vinculado. Use o campo acima para enviar um
              convite.
            </p>
          )}
        </CardContent>
